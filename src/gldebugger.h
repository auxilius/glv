...
bool modelData(std::string caption, float * data, float min = 0.0f, float max = 1.0f, int colorMap = GLV_COLORMAP_RAINBOW );

/* Assign a per vertex data array to the vertex buffer and create a collor buffer to increase render efficiency */
bool modelColor(std::string caption, float * data, float min = 0.0f, float max = 1.0f, int colorMap = GLV_COLORMAP_RAINBOW );
